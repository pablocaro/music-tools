...
window.SR_I18N = {
  ...
  en: {
    ...
    // the licence texts; this is the human half.
    "help.g.credits":   "Built with",
    "help.credits":     "The exercises are generated by OSME and engraved by VexFlow, through OpenSheetMusicDisplay \u2014 open-source projects by PhonicScore and Mohit Muthanna Cheppudira. The marimba, piano and vibraphone are real recordings from the Versilian Community Sample Library, released to the public domain. The typeface is Rubik. Full licences are in THIRD-PARTY.md.",
