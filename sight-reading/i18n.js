...
window.SR_I18N = {
  ...
  en: {
    ...
    "val.apart":       "Apart",
    // "Preset" named the mechanism — stored settings. A drill is what the thing
    // is: something you practise, that gives you different material each time.
    // It also makes the item labels correct, since they state vocabulary
    // ("Thirds") and rely on the container to say what you do with it.
    "sec.presets":     "Drills",
    "sec.allDrills":   "All drills",
    "lbl.newDrill":    "New drill",
    "lbl.saveEdited":  "Save \u201c{name} \u00b7 edited\u201d",
    "lbl.restore":     "Restore {name} \u00b7 edited",
    "lbl.yours":       "Yours",
    "lbl.builtIn":     "Built in",
    "lbl.back":        "Back",
    "val.edited":      "edited",
    "sum.steps":       "steps",
    "sum.to":          "to",
    "sum.chromatic":   "chromatic",
    "sum.sixteenths":  "16ths",
    "sum.triplets":    "triplets",
    "sum.dotted":      "dotted",
    "sum.eighths":     "eighths",
    "lbl.rename":      "Rename",
    "lbl.update":      "Update from the panel",
    "lbl.delete":      "Delete",
    "aria.drillMore":  "Rename, update or delete {name}",
    "sec.tempo":       "Tempo",
    ...
    "aria.volume":       "Volume",
    "aria.voice":        "Voice",
    "aria.hideAhead":    "Hide ahead",
    "aria.hideUnit":     "Hide ahead unit",
    "aria.clef":         "Clef",
    "aria.pickKeys":     "Keys this drill rotates through",
    "aria.pickMeters":   "Meters this drill rotates through",
    "aria.pickBars":     "Length",
    "sec.instrument":  "Instrument",
    "aria.pickInstrument": "Instrument",
    ...
    "msg.newPresetName": "Name this drill:",
    "msg.renameDrill":   "Rename “{name}” to:",
    "msg.deletePreset":  "Delete the drill “{name}”? This cannot be undone.",
  ...
  es: {
    ...
    "val.apart":       "Sueltas",
    "sec.presets":     "Ejercicios",
    "sec.allDrills":   "Todos los ejercicios",
    "lbl.newDrill":    "Nuevo ejercicio",
    "lbl.saveEdited":  "Guardar \u201c{name} \u00b7 editado\u201d",
    "lbl.restore":     "Recuperar {name} \u00b7 editado",
    "lbl.yours":       "Tuyos",
    "lbl.builtIn":     "Incluidos",
    "lbl.back":        "Atr\u00e1s",
    "val.edited":      "editado",
    "sum.steps":       "grados",
    "sum.to":          "a",
    "sum.chromatic":   "crom\u00e1tico",
    "sum.sixteenths":  "semicorcheas",
    "sum.triplets":    "tresillos",
    "sum.dotted":      "puntillo",
    "sum.eighths":     "corcheas",
    "lbl.rename":      "Renombrar",
    "lbl.update":      "Actualizar con el panel",
    "lbl.delete":      "Eliminar",
    "aria.drillMore":  "Renombrar, actualizar o eliminar {name}",
    "sec.tempo":       "Tempo",
    ...
    "aria.tempo":        "Tempo",
    "aria.slurOf":       "Ligadura de",
    "aria.slower":       "Más lento",
    "aria.faster":       "Más rápido",
    "aria.lower":        "Más grave",
    "aria.higher":       "Más aguda",
    "aria.less":         "Menos",
    "aria.more":         "Más",
    "aria.volume":       "Volumen",
    "aria.voice":        "Instrumento",
    "aria.hideAhead":    "Ocultar por delante",
    "aria.hideUnit":     "Unidad",
    "aria.clef":         "Clave",
    "aria.pickKeys":     "Tonalidades que rota este ejercicio",
    "aria.pickMeters":   "Compases que rota este ejercicio",
    "aria.pickBars":     "Duraci\u00f3n",
    "sec.instrument":  "Instrumento",
    "aria.pickInstrument": "Instrumento",
    ...
    "msg.newPresetName": "Nombre del ejercicio:",
    "msg.renameDrill":   "Renombrar “{name}” a:",
    "msg.deletePreset":  "¿Eliminar el ejercicio “{name}”? No se puede deshacer.",
